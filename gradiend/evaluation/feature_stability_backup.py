...
if __name__ == '__main__':
    ...
    base_models = [base_model, base_model + '-Instruct']
    ...
    for base_model in base_models:
        if base_model in ['roberta-large']: # 'distilbert-base-cased'
            model_ids = [
                f'results/experiments/gradiend/gender-en/{base_model}/0',
                f'results/experiments/gradiend/gender-en/{base_model}/1',
                f'results/experiments/gradiend/gender-en/{base_model}/2',
                #f'results/experiments/gradiend/gender-en/{base_model}/3',
                #f'results/experiments/gradiend/gender-en/{base_model}/4',
            ]
        elif base_model in ['bert-base-cased', 'bert-large-cased', 'roberta-large']:
            model_ids = [
                f'results/experiments/gradiend/{base_model}/vFinal/0',
                f'results/experiments/gradiend/{base_model}/vFinal/1',
                f'results/experiments/gradiend/{base_model}/vFinal/2',
            ]
            ...
            model_ids = [
                f'results/experiments/gradiend/{base_model}/v/0',
                f'results/experiments/gradiend/{base_model}/v/1',
                f'results/experiments/gradiend/{base_model}/v/2',
            ]
        else:
            model_ids = [
                f'results/experiments/gradiend/gender-en/{base_model}/feature_stability/0',
                f'results/experiments/gradiend/gender-en/{base_model}/feature_stability/1',
                f'results/experiments/gradiend/gender-en/{base_model}/feature_stability/2',
            ]
